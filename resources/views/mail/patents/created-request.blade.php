...
<head>
    ...
    <title>Comprobante de Solicitud de Patente</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="email-container">
                ...
                <tr>
                    <td>
                        <div class="header-text">
                            <h1>Comprobante de Solicitud de Patente</h1>
        ...
        <div class="content">
            ...
            <p class="intro-text">
                Le informamos que su solicitud de patente ha sido <strong>recibida</strong> exitosamente.
                A continuación, detallamos la información de su solicitud registrada el día {{ $patentRequest->created_at->format('d-m-Y H:i') }}.
            </p>
            ...
            <table class="data-table">
                ...
                <tr>
                    <td>Estado</td>
                    <td><span class="status-pending">Pendiente de Revisión</span></td>
                </tr>
                <tr>
                    <td>Fecha de Recepción</td>
                    <td>{{ $patentRequest->created_at->format('d-m-Y H:i') }}</td>
                </tr>
                <tr>
                    <td>Solicitante</td>
            ...
            <div class="info-box">
                ...
                <div class="info-box-text">
                    ...
                    Le recomendamos guardarlo para cualquier consulta futura sobre su solicitud comercial.
                </div>
            </div>
            ...
            <ul class="steps-list">
                <li>Su solicitud será revisada por el departamento de Rentas Municipales</li>
                <li>Recibirá una notificación por email cuando haya una actualización</li>
                <li>Puede hacer seguimiento de su solicitud usando el código proporcionado</li>
                <li>Si es aprobada, recibirá los formularios y requerimientos necesarios</li>
            </ul>
        </div>
