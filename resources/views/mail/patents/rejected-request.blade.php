...
<head>
    ...
    <title>Comprobante de Rechazo de Patente</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="email-container">
                ...
                <tr>
                    <td>
                        <div class="header-text">
                            <h1>Comprobante de Rechazo de Patente</h1>
        ...
        <div class="content">
            ...
            <p class="intro-text">
                Le informamos que su solicitud de patente ha sido <strong>rechazada</strong>.
            ...
            <!-- Info Box -->
            <div class="info-box">
                <div class="info-box-title">Importante: Solicitud Rechazada</div>
                <div class="info-box-text">
                    Su solicitud de patente ha sido rechazada. Si tiene dudas sobre esta decisión, 
                    puede contactar directamente con la Dirección de Rentas Municipales para mayor información.
                </div>
            </div>
            ...
            <h2 class="section-title">¿Qué significa este resultado?</h2>
            <ul class="steps-list">
                <li>La solicitud no cumple con los requisitos establecidos en la ordenanza municipal</li>
                <li>Podrá presentar una nueva solicitud si corrige los aspectos observados</li>
                <li>Le recomendamos revisar los requisitos antes de volver a postular</li>
                <li>Para consultas específicas, diríjase a la oficina de Rentas Municipales</li>
            </ul>
        </div>
