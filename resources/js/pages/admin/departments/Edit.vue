...
import { index, update } from '@/routes/admin/departments';
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Editar', href: update(props.department.id).url },
];

const selectedIcon = ref(props.department.icon || 'Building2');
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="container mx-auto max-w-4xl space-y-6 p-6 md:p-8">
            <!-- Header -->
            <div>
                <h1 class="text-xl font-bold text-gray-900">Editar Departamento</h1>
            </div>
            <Form :action="update(department.id)" v-slot="{ errors, processing }" class="space-y-6">
                <Card>
                    <CardHeader>
                    ...
                    <CardContent class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="text-sm text-gray-500">
                                El slug no se puede modificar después de crear el departamento.
                            </p>
                        </div>
                        <div class="space-y-2">
                    ...
                    <CardContent class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <Input
                                ...
                                name="color"
                                :tabindex="5"
                                :default-value="department.color"
                                type="color"
                                required
