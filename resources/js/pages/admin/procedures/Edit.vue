...
import { edit, index, update } from '@/routes/admin/procedures';
...
interface ProcedureRequirement extends Requirement {
    pivot: {
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Editar Trámite', href: edit(props.procedure.id).url },
];

const selectedRequirement = ref<{ id: number; is_mandatory: boolean; order: number }[]>(
    props.procedure.requirements.map((r) => ({
        id: r.id,
        is_mandatory: Boolean(r.pivot.is_mandatory),
        order: r.pivot.order,
    })),
);

const userRequeriments = ref<string[]>(props.procedure.user_requirements ?? []);
const instructions = ref<string[]>(props.procedure.instructions ?? []);
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="container mx-auto max-w-4xl space-y-6 p-6 md:p-8">
            <!-- Header -->
            <div>
                <h1 class="text-xl font-bold text-gray-900">Editar Trámite</h1>
            </div>
            <Form
                :action="update(procedure.id)"
            ...
            >
                    ...
                    <CardContent class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <Input
                                ...
                                :tabindex="2"
                                type="text"
                                :default-value="procedure.description ?? ''"
                ...
                <Card>
                    ...
                    <CardContent class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            >
                            <Select name="category_id" :default-value="procedure.category_id">
                                <SelectTrigger id="category_id" :tabindex="3">
                                    <SelectValue placeholder="Seleccionar categoría" />
                                </SelectTrigger>
                                <SelectContent>
                                    <template
                                        v-for="(cats, deptName) in categories"
                                        :key="deptName"
                                    >
                                        <div
                        ...
                        <div class="space-y-2">
                            ...
                            >
                            <Select name="modality" :default-value="procedure.modality">
                    ...
                    <CardContent class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <Input
                                ...
                                name="duration"
                                type="text"
                                :default-value="procedure.duration ?? ''"
                        ...
                        <div class="space-y-2">
                            <div class="flex items-center gap-2">
                                <Switch
                                    ...
                                    id="is_active"
                                    name="is_active"
                                    :default-value="procedure.is_active"
                                />
                    ...
                    <CardContent class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <Textarea
                                ...
                                :default-value="procedure.legal_framework ?? ''"
                                :tabindex="12"
                                placeholder="Ley, decreto o normativa que respalda este trámite..."
                                rows="2"
                            />
                            <InputError :message="errors.legal_framework" />
                        </div>
                ...
                <div class="flex justify-end gap-4">
                    ...
                    <Button type="submit" :disabled="processing" :tabindex="14">
                        ...
                        {{ processing ? 'Editando...' : 'Editar Trámite' }}
                    </Button>
                </div>
            </Form>
        </div>
