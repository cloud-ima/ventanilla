...
const breadcrumbs: BreadcrumbItem[] = [{ title: 'Categorías', href: index().url }];
...
const categoriaToDelete = ref<Category | null>(null);

function openDeleteDialog(categoria: Category) {
...
function confirmDelete() {
    if (categoriaToDelete.value) {
        router.delete(`/admin/categories/${categoriaToDelete.value.id}`, {
            preserveScroll: true,
            onStart: () => {
                deleteToastId = toast.loading('Eliminando categoría...');
            },
            onSuccess: () => {
            ...
            <Card>
                ...
                <CardContent>
                    <Table>
                        ...
                        <TableBody>
                            <TableRow v-for="category in response.data" :key="category.id">
                                <TableCell class="font-medium">{{ category.name }}</TableCell>
                                <TableCell>{{ category.department.name }}</TableCell>
                                <TableCell>{{ category.procedures_count }}</TableCell>
                                    ...
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuContent align="end">
                                            ...
                                            <DropdownMenuItem
                                                ...
                                                @select="openDeleteDialog(category)"
                                            >
        ...
        <AlertDialogContent>
            <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                    ...
                    }}" y todos sus trámites asociados.
                </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
