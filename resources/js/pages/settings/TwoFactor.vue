            ...
            <div class="space-y-6">
                ...
                >
                    ...
                    <p class="text-muted-foreground">
                        Cuando habilites la autenticación de dos factores, se te pedirá un pin
                        seguro durante el inicio de sesión. Este pin puede ser recuperado desde una
                ...
                <div v-else class="flex flex-col items-start justify-start space-y-4">
                    ...
                    <p class="text-muted-foreground">
                        La autenticación de dos factores está habilitada. Usa una aplicación de
                        autenticación para generar tokens de acceso temporales.
                    </p>
